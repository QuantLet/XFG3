...
%-------------------------------------------------------------------------------
% Quantlet: exp_rtn_ES_2d
%-------------------------------------------------------------------------------
% Description: Compute the values of the expected returns and the ES of the 
...
% Inputs: None
%-------------------------------------------------------------------------------
% Output: Plots of the expected returns and the ES of the optimal portfolios 
%         with different holding weights of the 1st underlying asset
%         under an EGARCH(1,1) model, where the number of assets is 2.
%-------------------------------------------------------------------------------
% Keywords: expected shortfall, garch, linear programming, portfolio, 
